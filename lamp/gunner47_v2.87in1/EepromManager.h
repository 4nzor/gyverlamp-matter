...
//    }
    ...
    static void RestoreDefaultModesSettings(ModeType modes[])
    {
      for (uint8_t i = 0; i < MODE_AMOUNT; i++)
      {
    ...
    static void RestoreDefaultGlobalSettings()
    {
      // Восстановление глобальных настроек по умолчанию
      // Здесь можно добавить восстановление других глобальных настроек, если нужно
    }
